...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    protected void renderSpecials(AbstractClientPlayer par1AbstractClientPlayer, float par2)
    {
		...
		//START CODE
        AutoRefereePlayer apl = AutoReferee.get().getPlayer(par1AbstractClientPlayer.getCommandSenderName());
		if (apl!=null && apl.getCape()!=null && var25 && var26)
        //END CODE
        {
			//START CODE
            //this.func_110776_a(par1AbstractClientPlayer.func_110303_q());
			this.func_110776_a(apl.getCape());
            //END CODE
            GL11.glPushMatrix();
